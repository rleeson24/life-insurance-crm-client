  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        'mdb-reader': path.resolve(import.meta.dirname, 'node_modules/mdb-reader/lib/browser/index.js'),
        'create-hash': path.resolve(import.meta.dirname, 'node_modules/create-hash/browser.js'),
      },
    },
    test: {
      environment: 'jsdom',
